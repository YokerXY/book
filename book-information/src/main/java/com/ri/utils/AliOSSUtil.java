...
public class AliOSSUtil {
    ...
    public static String ossUpload(File file) {
        String bucketDomain = "https://wacwp.oss-cn-hangzhou.aliyuncs.com/";
        //Endpoint以北京为例，其它Region请按实际情况填写
        String endpoint = "http://oss-cn-hangzhou.aliyuncs.com";
        //accessKeyId和accessKeySecret，请填写自己的
        String accessKeyId = "LTAIadFXdcGXF05L";
        String accessKeySecret = "Uyj2jNVhOtR0eqiLwHy0TOuuSp93iJ";
        //Bucket名称
        String bucketName = "wacwp";
        //目录名称
        String filedir = "logo/";
        //获得本地文件的文件名
